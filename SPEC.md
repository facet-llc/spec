...
The protocol composes four open standards into a single coherent rail:
...
Facet does not redefine any of these standards. It defines:
...
## 6. Audit (Ed25519 — extension above the spec)

Every settled transaction returns a signed audit record. This is **above the open standards** and is Facet-specific:
...
- KYAPay — IETF Independent Submission for agent identity. Locate the latest draft at <https://datatracker.ietf.org> by searching for `kyapay`.
...
A v0.1-conformant implementation MUST implement Sections 2, 3, 4, 5. Section 6 is RECOMMENDED but optional in v0.1; REQUIRED in v0.2.

---

*This is a working draft. Issues, RFC discussions, and implementations welcome at <https://github.com/facet-llc/protocol>.*
